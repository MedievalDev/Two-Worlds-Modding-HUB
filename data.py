...
GUIDES = [
    {
        "id": "console_commands",
        "title_en": "Console and console commands",
        "title_de": "Konsole und Konsolenbefehle",
        "icon": "",
        "tags": ['console', 'commands', 'cheats', 'fps', 'performance', 'autoexec'],
        "tool_ids": [],
        "file_en": "forum_console_en.txt",
        "file_de": "forum_console_de.txt",
        "fallback_en": "How the console works, batch files, autoexecGame2.con, the command list and two performance settings. From the archived InsideTwoWorlds forum.",
        "fallback_de": "Wie die Konsole arbeitet, Stapeldateien, autoexecGame2.con, die Befehlsliste und zwei Leistungseinstellungen. Aus dem archivierten InsideTwoWorlds-Forum.",
    },
    {
        "id": "create_command",
        "title_en": "CREATE - spawning items",
        "title_de": "CREATE - Gegenstaende erschaffen",
        "icon": "",
        "tags": ['console', 'create', 'items', 'cheats', 'armour'],
        "tool_ids": ['par_editor_af'],
        "file_en": "forum_create_en.txt",
        "file_de": "forum_create_de.txt",
        "fallback_en": "The CREATE command: how it is written, what the three parameters mean, and the names of the armour sets and equipment.",
        "fallback_de": "Der Befehl CREATE: Schreibweise, was die drei Parameter bedeuten, und die Namen der Ruestungssaetze und Ausruestung.",
    },
    {
        "id": "editor_controls",
        "title_en": "Two Worlds Editor - the controls",
        "title_de": "Two Worlds Editor - die Steuerung",
        "icon": "",
        "tags": ['editor', 'controls', 'keys', 'objects', 'terrain'],
        "tool_ids": ['tw_editor', 'cmd_injector'],
        "file_en": "forum_editor_keys_en.txt",
        "file_de": "forum_editor_keys_de.txt",
        "fallback_en": "Every key of the Two Worlds Editor, sorted by tool set. From the archived InsideTwoWorlds forum.",
        "fallback_de": "Jede Taste des Two Worlds Editors, nach Werkzeugsatz sortiert. Aus dem archivierten InsideTwoWorlds-Forum.",
    },
    {
        "id": "guide_wdpacker",
        "title_en": "TW1 WD Packer - the guide",
        "title_de": "TW1 WD Packer - die Anleitung",
        "icon": "",
        "tags": ['wd', 'unpack', 'pack', 'archive'],
        "tool_ids": ['wd_packer'],
        "file_en": "tool_wdpacker_en.txt",
        "file_de": "tool_wdpacker_de.txt",
        "fallback_en": "The guide of the WD Packer: unpacking, packing, what unpacking keeps, the flags reference.",
        "fallback_de": "Die Anleitung des WD Packers: Entpacken, Packen, was beim Entpacken mitkommt, die Kennzeichen-Referenz.",
    },
    {
        "id": "guide_modmanager",
        "title_en": "TW1 Mod Manager - the guide",
        "title_de": "TW1 Mod Manager - die Anleitung",
        "icon": "",
        "tags": ['mods', 'registry', 'install', 'merge'],
        "tool_ids": ['mod_manager'],
        "file_en": "tool_modmanager_en.txt",
        "file_de": "tool_modmanager_de.txt",
        "fallback_en": "The guide of the Mod Manager: installing, switching, the registry, merging two mods.",
        "fallback_de": "Die Anleitung des Mod Managers: Einlegen, Umschalten, die Registry, zwei Mods zusammenfuehren.",
    },
    {
        "id": "guide_pareditor",
        "title_en": "TW1 PAR Editor - the guide",
        "title_de": "TW1 PAR Editor - die Anleitung",
        "icon": "",
        "tags": ['par', 'items', 'npcs', 'fields'],
        "tool_ids": ['par_editor_af'],
        "file_en": "tool_pareditor_en.txt",
        "file_de": "tool_pareditor_de.txt",
        "fallback_en": "The guide of the PAR Editor: groups and filter, editing fields, compare and merge, packing into a mod.",
        "fallback_de": "Die Anleitung des PAR Editors: Gruppen und Filter, Felder bearbeiten, Vergleichen und Zusammenfuehren, in eine Mod packen.",
    },
    {
        "id": "guide_dungeoneditor",
        "title_en": "TW1 Dungeon Editor - the guide",
        "title_de": "TW1 Dungeon Editor - die Anleitung",
        "icon": "",
        "tags": ['dungeon', 'sdk', 'layout', 'export'],
        "tool_ids": ['dungeon_editor_af'],
        "file_en": "tool_dungeoneditor_en.txt",
        "file_de": "tool_dungeoneditor_de.txt",
        "fallback_en": "The guide of the Dungeon Editor: painting a layout and exporting it for the Two Worlds Editor.",
        "fallback_de": "Die Anleitung des Dungeon-Editors: Grundriss malen und fuer den Two Worlds Editor ausgeben.",
    },
    {
